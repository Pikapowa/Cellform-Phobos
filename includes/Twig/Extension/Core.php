...
class Twig_Extension_Core extends Twig_Extension
{
    ...
    public function getFilters()
    {
        $filters = array(
			...
			// bbcode
			new Twig_SimpleFilter('bbcode', 'twig_bbcode'),
...
function twig_bbcode($value)
{
	$pattern[0] = '/\[b\](.*?)\[\/b\]/is';
	$pattern[1] = '/\[url=(.*?)\](.*?)\[\/url\]/is';
	$pattern[2] = '/\[img size=(.*?)\](.*?)\[\/img\]/is';

	$replace[0] = '<strong>$1</strong>';
	$replace[1] = '<a href="$1">$2</a>';
	$replace[2] = '<img class="CellformBanAvatar" src="$2" width="$1"/>';
